    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 overflow-hidden relative">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          <div className="inline-flex w-24 h-24 p-1 rounded-full bg-[#25D366]/10 border border-[#25D366]/20 mb-6 overflow-hidden items-center justify-center animate-bounce-slow">
            <img src={logoImage} className="w-full h-full object-cover rounded-full" alt="Logo" />
          </div>
