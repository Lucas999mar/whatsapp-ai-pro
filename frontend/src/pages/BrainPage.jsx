            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="glass-panel p-6 border-white/5 space-y-4">
                        ...
                        <div className="flex justify-between items-center pt-2 border-t border-white/5">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 hover:from-purple-500/30 hover:to-blue-500/30 text-purple-300 rounded-xl text-xs font-bold border border-purple-500/20 transition-all"
                            >
                            ...
                            <button
                                ...
                                disabled={saving}
                                className="flex items-center gap-2 px-5 py-2.5 bg-purple-500 hover:bg-purple-600 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-purple-500/20"
                            >
                                <Save size={14} />
                    ...
                    {copilotSuggestions && (
                        <div className="glass-panel p-6 bg-purple-500/5 border-purple-500/20 animate-fade-in space-y-3">
                            ...
                            <div className="text-xs text-slate-300 leading-relaxed whitespace-pre-wrap font-sans bg-[#0F172A]/70 p-4 rounded-xl border border-white/5">
                                {copilotSuggestions}
                            </div>
                        </div>
                    )}
                ...
                <div className="lg:col-span-1 flex flex-col h-full min-h-[450px]">
                    <div className="glass-panel p-4 border-white/5 flex justify-between items-center">
                        ...
                        <span className="text-[10px] text-slate-500 italic">Interativo</span>
                    </div>

                    <div className="glass-panel flex-1 bg-[#090D1A] border-white/5 relative overflow-hidden rounded-b-2xl" style={{ height: '400px' }}>
                        <canvas
                            ref={canvasRef}
